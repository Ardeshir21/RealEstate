    ...
    $('.slider-range-price').each(function () {
        ...
        $(this).slider({
            ...
            slide: function (event, ui) {
                ...
                t.closest('.slider-range').find('.range').html(thousands_separators(result));
                t.closest('.slider-range').find('#minval').val(ui.values[0]);
                t.closest('.slider-range').find('#maxval').val(ui.values[1]);
            }
        });
    })
